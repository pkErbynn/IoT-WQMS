...
# conect = sqlite3.connect('aqua_aid.db')
conect = sqlite3.connect('aqua_aid.db', check_same_thread=False)
cursor = conect.cursor()

def create_table():
    cursor.execute( 
        """ CREATE TABLE IF NOT EXISTS aqua_aid( 
...
# def data_entry():
#     cursor.execute(
#         """ INSERT INTO aqua_aid(temp, humidity, ph, salinity) 
...
def dynamic_data_entry():
    ...
    cursor.execute(""" INSERT INTO aqua_aid(temp, humidity, ph, salinity) VALUES (?, ?, ?, ?) """,
...
def read_data_from_db():
    cursor.execute(" SELECT * FROM aqua_aid ")
...
# hum=44
# temp=35
# insert3 = """INSERT INTO aqua_aid(temp, humidity, ph, salinity) 
#              VALUES(?, ?, ?, ?)"""
